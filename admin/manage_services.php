...
<div class="admin-container">
    ...
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="manage_services.php" class="active"><i class="fa-solid fa-concierge-bell"></i> Manage Services</a></li>
                    ...
                    <?php if(mysqli_num_rows($result) > 0): ?>
                        <?php while ($row = mysqli_fetch_assoc($result)): ?>
                            <tr>
                                ...
                                <td class="actions">
                                    <a href="edit_services.php?id=<?= $row['id']; ?>" class="edit-btn"><i class="fa-solid fa-pen"></i></a>
                                    <a href="manage_services.php?delete=<?= $row['id']; ?>" class="delete-btn" onclick="return confirm('Are you sure you want to delete this service?');"><i class="fa-solid fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    <?php else: ?>
